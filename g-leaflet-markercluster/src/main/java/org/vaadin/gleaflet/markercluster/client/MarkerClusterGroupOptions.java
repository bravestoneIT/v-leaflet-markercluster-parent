...
public class MarkerClusterGroupOptions extends JavaScriptObject {
	...
	public native final void setDisableClusteringAtZoom(int disableClusteringAtZoom)
	/*-{
	...
	public native final void setChunkedLoading(boolean chunkedLoading)
	/*-{
		this.chunkedLoading = chunkedLoading;
	}-*/;
	
	public native final void setChunkInterval(int chunkInterval)
	/*-{
		this.chunkInterval = chunkInterval;
	}-*/;
	
	public native final void setChunkDelay(int chunkDelay)
	/*-{
